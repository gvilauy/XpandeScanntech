...
/** Generated Model for Z_Stech_TMP_MovPago
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_Stech_TMP_MovPago extends PO implements I_Z_Stech_TMP_MovPago, I_Persistent 
{
    ...
    public X_Z_Stech_TMP_MovPago (Properties ctx, int Z_Stech_TMP_MovPago_ID, String trxName)
    {
      super (ctx, Z_Stech_TMP_MovPago_ID, trxName);
      /** if (Z_Stech_TMP_MovPago_ID == 0)
        {
			setSC_Cambio (false);
// N
			setZ_StechInterfaceVta_ID (0);
			setZ_Stech_TMP_Mov_ID (0);
			setZ_Stech_TMP_MovPago_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_Stech_TMP_MovPago (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_Stech_TMP_MovPago[")
	...
	/** Set Z_Stech_TMP_MovPago ID.
		@param Z_Stech_TMP_MovPago_ID Z_Stech_TMP_MovPago ID	  */
	public void setZ_Stech_TMP_MovPago_ID (int Z_Stech_TMP_MovPago_ID)
	{
		if (Z_Stech_TMP_MovPago_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_Stech_TMP_MovPago_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_Stech_TMP_MovPago_ID, Integer.valueOf(Z_Stech_TMP_MovPago_ID));
	}

	/** Get Z_Stech_TMP_MovPago ID.
		@return Z_Stech_TMP_MovPago ID	  */
	public int getZ_Stech_TMP_MovPago_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_Stech_TMP_MovPago_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
