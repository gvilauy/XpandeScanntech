...
public class X_Z_StechLoadInv extends PO implements I_Z_StechLoadInv, I_Persistent 
{
    ...
    public X_Z_StechLoadInv (Properties ctx, int Z_StechLoadInv_ID, String trxName)
    {
      super (ctx, Z_StechLoadInv_ID, trxName);
      /** if (Z_StechLoadInv_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_Z_StechLoadInv (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_StechLoadInv[")
	...
	public void setZ_StechLoadInv_ID (int Z_StechLoadInv_ID)
	{
		if (Z_StechLoadInv_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_StechLoadInv_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_StechLoadInv_ID, Integer.valueOf(Z_StechLoadInv_ID));
	}
