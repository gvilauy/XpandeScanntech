...
/** Generated Model for Z_Stech_TMP_Mov
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_Stech_TMP_Mov extends PO implements I_Z_Stech_TMP_Mov, I_Persistent 
{
    ...
    public X_Z_Stech_TMP_Mov (Properties ctx, int Z_Stech_TMP_Mov_ID, String trxName)
    {
      super (ctx, Z_Stech_TMP_Mov_ID, trxName);
      /** if (Z_Stech_TMP_Mov_ID == 0)
        {
...
// N
    ...
    /** Load Constructor */
    public X_Z_Stech_TMP_Mov (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_Stech_TMP_Mov[")
	...
	public void setZ_Stech_TMP_Mov_ID (int Z_Stech_TMP_Mov_ID)
	{
		if (Z_Stech_TMP_Mov_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_Stech_TMP_Mov_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_Stech_TMP_Mov_ID, Integer.valueOf(Z_Stech_TMP_Mov_ID));
	}
