...
/** Generated Model for Z_Stech_TMP_MovDetDtos
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_Stech_TMP_MovDetDtos extends PO implements I_Z_Stech_TMP_MovDetDtos, I_Persistent 
{
    ...
    public X_Z_Stech_TMP_MovDetDtos (Properties ctx, int Z_Stech_TMP_MovDetDtos_ID, String trxName)
    {
      super (ctx, Z_Stech_TMP_MovDetDtos_ID, trxName);
      /** if (Z_Stech_TMP_MovDetDtos_ID == 0)
        {
			setZ_StechInterfaceVta_ID (0);
			setZ_Stech_TMP_MovDetDtos_ID (0);
			setZ_Stech_TMP_MovDet_ID (0);
			setZ_Stech_TMP_Mov_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_Stech_TMP_MovDetDtos (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_Stech_TMP_MovDetDtos[")
	...
	/** Set Z_Stech_TMP_MovDetDtos ID.
		@param Z_Stech_TMP_MovDetDtos_ID Z_Stech_TMP_MovDetDtos ID	  */
	public void setZ_Stech_TMP_MovDetDtos_ID (int Z_Stech_TMP_MovDetDtos_ID)
	{
		if (Z_Stech_TMP_MovDetDtos_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_Stech_TMP_MovDetDtos_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_Stech_TMP_MovDetDtos_ID, Integer.valueOf(Z_Stech_TMP_MovDetDtos_ID));
	}

	/** Get Z_Stech_TMP_MovDetDtos ID.
		@return Z_Stech_TMP_MovDetDtos ID	  */
	public int getZ_Stech_TMP_MovDetDtos_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_Stech_TMP_MovDetDtos_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public I_Z_Stech_TMP_MovDet getZ_Stech_TMP_MovDet() throws RuntimeException
    {
		return (I_Z_Stech_TMP_MovDet)MTable.get(getCtx(), I_Z_Stech_TMP_MovDet.Table_Name)
			.getPO(getZ_Stech_TMP_MovDet_ID(), get_TrxName());	}

	/** Set Z_Stech_TMP_MovDet ID.
		@param Z_Stech_TMP_MovDet_ID Z_Stech_TMP_MovDet ID	  */
	public void setZ_Stech_TMP_MovDet_ID (int Z_Stech_TMP_MovDet_ID)
	{
		if (Z_Stech_TMP_MovDet_ID < 1) 
			set_Value (COLUMNNAME_Z_Stech_TMP_MovDet_ID, null);
		else 
			set_Value (COLUMNNAME_Z_Stech_TMP_MovDet_ID, Integer.valueOf(Z_Stech_TMP_MovDet_ID));
	}

	/** Get Z_Stech_TMP_MovDet ID.
		@return Z_Stech_TMP_MovDet ID	  */
	public int getZ_Stech_TMP_MovDet_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_Stech_TMP_MovDet_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (I_Z_Stech_TMP_Mov)MTable.get(getCtx(), I_Z_Stech_TMP_Mov.Table_Name)
			.getPO(getZ_Stech_TMP_Mov_ID(), get_TrxName());	}

	/** Set Z_Stech_TMP_Mov ID.
		@param Z_Stech_TMP_Mov_ID Z_Stech_TMP_Mov ID	  */
	public void setZ_Stech_TMP_Mov_ID (int Z_Stech_TMP_Mov_ID)
	{
		if (Z_Stech_TMP_Mov_ID < 1) 
			set_Value (COLUMNNAME_Z_Stech_TMP_Mov_ID, null);
		else 
			set_Value (COLUMNNAME_Z_Stech_TMP_Mov_ID, Integer.valueOf(Z_Stech_TMP_Mov_ID));
	}

	/** Get Z_Stech_TMP_Mov ID.
		@return Z_Stech_TMP_Mov ID	  */
	public int getZ_Stech_TMP_Mov_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_Stech_TMP_Mov_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
