...
/** Generated Model for Z_Stech_TMP_MovDet
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_Stech_TMP_MovDet extends PO implements I_Z_Stech_TMP_MovDet, I_Persistent 
{
    ...
    public X_Z_Stech_TMP_MovDet (Properties ctx, int Z_Stech_TMP_MovDet_ID, String trxName)
    {
      super (ctx, Z_Stech_TMP_MovDet_ID, trxName);
      /** if (Z_Stech_TMP_MovDet_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_Z_Stech_TMP_MovDet (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_Stech_TMP_MovDet[")
	...
	public void setZ_Stech_TMP_MovDet_ID (int Z_Stech_TMP_MovDet_ID)
	{
		if (Z_Stech_TMP_MovDet_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_Stech_TMP_MovDet_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_Stech_TMP_MovDet_ID, Integer.valueOf(Z_Stech_TMP_MovDet_ID));
	}
